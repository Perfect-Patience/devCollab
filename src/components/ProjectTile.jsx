...
function ProjectTile ({project}) {
  ...
  return (
    <div className=' p-5 rounded-xl  min-w-[300px] cursor-pointer hover:translate-y-2 duration-300' onClick={() => navigate(project._id)} style={{backgroundColor: 'rgba(217, 217, 217, 0.17)'}}>
        ...
        <div className='flex mb-5 gap-2.5'>
            {/* Use project.techStack and provide a fallback empty array */}
        ...
        <div className='flex items-center justify-between'>
            ...
            <p className="truncate">{project.ownerId?.username || "no name"}</p>
            </div>
            </div>
    </div>
  )
